...
document.addEventListener("DOMContentLoaded", function(event) {
  ...
  document.getElementById("inputText").addEventListener("submit",submit)
});
...
//submit while press enter key, and make a new list
function submit(event){
  ...
  //crate new div element for newList
  ...
  const checkbox = document.createElement("input");
    ...
    checkbox.classList.add("checkbox"); //bisa custom maka css sendiri. di style css nya bs class .checkbox{}
    checkbox.innerHTML = `
  ...
  document.getElementById("newList").appendChild(newList);
