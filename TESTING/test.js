  ...
  form.addEventListener("submit", function(event){
    ...
    editButton.addEventListener('click', function (e)  {
      ...
      if (inputValue.contentEditable === "false") {
        ...
        inputValue.contentEditable = "true";
        inputValue.focus(); 
        inputValue.select();//it can't. try to change the span into textinput
        //This work. Please make it when we clicked, it will selected ALL chr on Input, and when we clicked enter it will be assigned as save.
        
        //inputValue.ariaSelected();
        //inputValue.onselect();
        // inputValue.select();
      }else {
