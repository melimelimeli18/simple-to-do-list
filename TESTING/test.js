...
// Submit input, line through when clicked the checkbox
...
function outerSubmit (){
  ...
  form.addEventListener("submit", function(event){
    ...
    // edit button submited??
      // ketika gw pencet enter saat mengedit, itu bakal ngubah text jadi readable doang
    
    //   inputValue.addEventListener("submit", function saveEdit(){
    //   if ()
    // })
